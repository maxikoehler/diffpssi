...
MK edit 5.10: changed import paths to enable local development; adapted plots and added voltage at bus 8
"""
...
# sys.path.insrt(1, "/Users/maxikoehler/Documents/GitHub/diffpssi-ma-kohler/examples/models/ieee_9bus")
import ieee_9bus_model as mdl

# sys.path.insert(1, "/Users/maxikoehler/Documents/GitHub/diffpssi-ma-kohler/src/diffpssi/power_sim_lib")
...
def record_desired_parameters(simulation):
    ...
    record_list = [
        ...
        # simulation.busses[2].models[0].omega.real,
        # simulation.busses[2].models[0].p_e,
        # simulation.busses[7].voltage,
        # simulation.busses[0].voltage,
        simulation.busses[1]
        .models[0]
        .p_e,
    ]
...
def main():
    ...
    # np.save('./examples/models/ieee_9bus/data/original_data.npy', recorder[0].real)
    # np.save('./examples/models/ieee_9bus/data/original_data_t.npy', saver)
