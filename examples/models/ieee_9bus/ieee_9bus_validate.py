...
plt.plot(
    data_pf[:length, 0], data_pf[:length, 2] - 1, linestyle=":", color="C0", linewidth=2
)
...
plt.plot(
    data_pf[:length, 0], data_pf[:length, 3], linestyle=":", color="C0", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 6], color="C1", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 7], linestyle=":", color="C1", linewidth=2
)
...
plt.plot(
    data_pf[:length, 0], data_pf[:length, 4], linestyle=":", color="C0", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 7], color="C1", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 8], linestyle=":", color="C1", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 11], color="C2", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 12], linestyle=":", color="C2", linewidth=2
)
