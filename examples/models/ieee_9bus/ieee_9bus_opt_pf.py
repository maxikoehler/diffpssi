"""This example shows how to use the parameter identification module to identify the parameters of the generators in the IEEE 9 bus system in PowerFactory."""
...
def main():
    """Führt die Parameterschätzung für das IEEE-9-Bus-Modell durch."""
    t_start = time.time()
