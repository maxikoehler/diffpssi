"""This module contains the data for the simple infinite bus bar model with controllers."""


def load():
    """Gibt die Modelldaten für das Infinite-Bus-Bar-Modell mit Reglern als Dictionary zurück.

    Returns:
        dict: Modelldaten für das Infinite-Bus-Bar-Modell mit Reglern.
    """
    return {
        "base_mva": 2200,
        "f": 60,
