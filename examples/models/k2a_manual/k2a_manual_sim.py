...
def main():
    ...
    sim.add_exciter(
        SEXS(
            name="AVR1", gen="G1", k=100, t_a=2.0, t_b=10.0, t_e=0.1, e_min=-3, e_max=3
        )
    )
    sim.add_exciter(
        SEXS(
            name="AVR2", gen="G2", k=100, t_a=2.0, t_b=10.0, t_e=0.1, e_min=-3, e_max=3
        )
    )
    sim.add_exciter(
        SEXS(
            name="AVR3", gen="G3", k=100, t_a=2.0, t_b=10.0, t_e=0.1, e_min=-3, e_max=3
        )
    )
    sim.add_exciter(
        SEXS(
            name="AVR4", gen="G4", k=100, t_a=2.0, t_b=10.0, t_e=0.1, e_min=-3, e_max=3
        )
    )
