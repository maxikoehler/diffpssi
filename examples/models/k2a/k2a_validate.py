...
plt.plot(
    data_pf[:length, 0], data_pf[:length, 5] - 1, linestyle=":", color="C0", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 6], color="C1", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 6] - 1, linestyle=":", color="C1", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 7], color="C2", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 7] - 1, linestyle=":", color="C2", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 8], color="C3", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 8] - 1, linestyle=":", color="C3", linewidth=2
)
...
plt.plot(
    data_pf[:length, 0], data_pf[:length, 9], linestyle=":", color="C0", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 10], color="C1", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 10], linestyle=":", color="C1", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 11], color="C2", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 11], linestyle=":", color="C2", linewidth=2
)

plt.plot(data_ours[:, 0], data_ours[:, 12], color="C3", linewidth=1)
plt.plot(
    data_pf[:length, 0], data_pf[:length, 12], linestyle=":", color="C3", linewidth=2
)
...
(l5,) = plt.plot(
    data_ours[0, 0], data_ours[0, 9], label="Python", color="black", linewidth=1
)
(l6,) = plt.plot(
    data_ours[0, 0],
    data_ours[0, 9],
...
leg1 = plt.legend(
    bbox_to_anchor=(0.0, -0.38, 1.0, 0.1),
    handles=[l1, l2, l3, l4],
    ncol=4,
    mode="expand",
    borderaxespad=0.0,
...
plt.legend(
    bbox_to_anchor=(0.0, -0.51, 1.0, 0.1),
    handles=[l5, l6],
    ncol=2,
    mode="expand",
    borderaxespad=0.0,
