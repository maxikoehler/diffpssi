"""This module contains classes for modeling static power system components.

These are could be loads, lines, and transformers.
Other components can be added here as well.
All components do not contain state variables and are therefore modeled as static components.
"""
...
class Line:
    ...
    def __init__(
        ...
        """
        Initializesthe Line object with the specified electrical parameters and connected buses.
...
class Transformer:
    ...
    def get_admittance_diagonal(self):
        """
        Calculate the diagonal admittance value of the transformer.
    ...
    def get_admittance_off_diagonal(self):
        """
        Calculate the off-diagonal admittance value of the transformer.
